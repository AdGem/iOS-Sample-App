...
# [1.4.0](https://github.com/AdGem/iOS-Sample-App/compare/1.3.0...1.4.0) (2026-07-30)


### Bug Fixes

* remove the coin-update observer on teardown in both samples ([fae187c](https://github.com/AdGem/iOS-Sample-App/commit/fae187cc41fad843580e295648735ed65b60540b))


### Features

* adopt AdGem iOS SDK 3.0.0 in both sample apps ([a560089](https://github.com/AdGem/iOS-Sample-App/commit/a56008921851db76a798cc9c9a4fd6a1ef57fe3d))
