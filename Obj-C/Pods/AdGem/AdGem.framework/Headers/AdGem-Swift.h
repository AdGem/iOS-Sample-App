...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AdGem",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@protocol AdGemDelegate;
enum AdGemGender : NSInteger;

SWIFT_CLASS("_TtC5AdGem5AdGem")
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL readyToPlayVideo;)
+ (BOOL)readyToPlayVideo SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) BOOL readyToPlayRewardedVideo;)
+ (BOOL)readyToPlayRewardedVideo SWIFT_WARN_UNUSED_RESULT;
...
+ (void)cacheOfferWall;
+ (void)showOfferWall;
+ (void)setPlayerIdWithPlayerId:(NSString * _Nonnull)playerId;
+ (void)setPlayerAgeWithAge:(NSInteger)age;
+ (void)setPlayerGenderWithGender:(enum AdGemGender)gender;
+ (void)setPlayerLevelWithLevel:(NSInteger)level;
+ (void)setPlayerPlacementWithPlace:(NSInteger)place;
+ (void)setPlayerCreatedAtCreatedDate:(NSDate * _Nullable)createdDate;
+ (void)setPlayerPayerWithSpentMoney:(BOOL)spentMoney;
+ (void)setPlayerIAPTotalWithIapTotal:(double)iapTotal;
+ (void)setCustomVariable1WithVariable:(NSString * _Nullable)variable;
+ (void)setCustomVariable2WithVariable:(NSString * _Nullable)variable;
+ (void)setCustomVariable3WithVariable:(NSString * _Nullable)variable;
+ (void)setCustomVariable4WithVariable:(NSString * _Nullable)variable;
+ (void)setCustomVariable5WithVariable:(NSString * _Nullable)variable;
+ (void)setStagingServerModeWithEnableStaging:(BOOL)enableStaging;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_PROTOCOL("_TtP5AdGem13AdGemDelegate_")
@protocol AdGemDelegate
...
typedef SWIFT_ENUM(NSInteger, AdGemGender, closed) {
  AdGemGenderMale = 0,
  AdGemGenderFemale = 1,
